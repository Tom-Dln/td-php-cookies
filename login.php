        ...
        <section class="md:w-1/4 mx-auto md:mt-20 p-3 bg-gray-300 dark:bg-gray-600 dark:text-gray-50 shadow-lg">
            ...
            <form action="" method="POST">
                <div class="mb-3">
                    ...
                    <!-- <input class="form-control focus:shadow-outline dark:text-gray-50" type="text"> -->
                    <input class="form-control focus:shadow-outline dark:text-gray-50" type="text" name="form_login" required>
                </div>
                <div class="mb-3">
                    <label class="form-label dark:text-gray-50" for="password">Mot de passe</label>
                    <!-- <input class="form-control focus:shadow-outline dark:text-gray-50" type="password"> -->
                    <input class="form-control focus:shadow-outline dark:text-gray-50" type="password" name="form_password" required>
                </div>
                <div class="mb-3">
                    <button class="px-8 py-4 bg-blue-500 hover:bg-blue-600 text-white shadow rounded" type="submit">Se connecter <?= $test; ?></button>
                </div>
            </form>
        </section>
    </main>
    <?php require_once __DIR__ . '/status.php'; ?>
</body>
